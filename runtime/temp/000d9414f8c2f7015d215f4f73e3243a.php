<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"C:\AppServ\www\oo\public/../xmyttz/rx\view\user\set_password.html";i:1515998789;s:27:"../xmyttz/view/rx_head.html";i:1520233375;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <div class="mui-content-padded" style="margin: 0px;margin-top: 14px">
                <form class="mui-input-group">
                    ...
                    <div class="mui-button-row">
                        <button type="button" class="mui-btn mui-btn-primary content_btn" >确认</button>
...
<div class="tanchu_system small" id="setpwd_success" >
    <div class="tanchu_system_box">
        <h3>登录密码修改成功</h3>
        <div class="question"><img src="/Public/img/success.png" alt=""><div class="tanchu_content"><p>登录密码修改成功,请重新登录！</p></div></div>
        <div class="answer">
...
<div class="tanchu_system small" id="setpwd_error">
    <div class="tanchu_system_box">
        ...
        <div class="question"><img src="/Public/img/error.png" alt=""><div class="tanchu_content"><p>请重新修改或联系客服！</p></div>
            <div class="answer">
                <a href="/<?php echo \think\Request::instance()->module(); ?>/<?php echo \think\Request::instance()->controller(); ?>/set_password" class="error">确定</a>
            </div>
        </div>
    </div>
</div>
