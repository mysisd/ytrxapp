<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:58:"C:\AppServ\www\tp\public/../xmyttz/rx\view\user\guide.html";i:1515998789;s:27:"../xmyttz/view/rx_head.html";i:1516669094;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<header id="head" class="mui-bar mui-bar-nav " style="background-color: rgb(250,250,250)">
   ...
   <h1 class="mui-title">新手指导</h1>
</header>
<div class="guide">
    <ul class="system_set" >
        <li style="top:30px">
            <div class="change_pa">
                <p class="cp">修改登录密码 <span >></span> <p class="line"></p></p>
            </div>
        </li>
        <li style="top:4px">
            <div class="change_pa">
