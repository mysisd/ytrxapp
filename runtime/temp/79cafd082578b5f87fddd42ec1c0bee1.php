<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:58:"C:\AppServ\www\oo\public/../xmyttz/rx\view\user\about.html";i:1515998789;s:27:"../xmyttz/view/rx_head.html";i:1520233375;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="about">
    <img src="/Public/img/banner/bg1.jpg" width="90px" height="90px" style="border-radius:3px; " alt=" 盈透金融">
    <p>盈透金融</p>
</div>
<div class="about_list">
<ul>
    <li>盈透金融服务条款 </li><p class="lines"></p>
    <li>盈透金融交易风险说明书 </li><p class="lines"></p>
    <li>盈透金融免责条款 </li><p class="lines"></p>
</ul>
</div>
</body>
</html>