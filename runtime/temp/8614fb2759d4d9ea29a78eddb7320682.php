<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"C:\AppServ\www\tp\public/../xmyttz/rx\view\user\per_info.html";i:1516759801;s:27:"../xmyttz/view/rx_head.html";i:1516669094;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        $.ajax({
            ...
            success:function (data) {
              ...
              $('#city_text').text(data['area']);
                $('.imgsd img').attr('src', data['face'].substr(17));
