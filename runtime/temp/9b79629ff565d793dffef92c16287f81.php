<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:59:"C:\AppServ\www\tp\public/../xmyttz/rx\view\user\index1.html";i:1516759682;s:27:"../xmyttz/view/rx_head.html";i:1517187779;s:29:"../xmyttz/view/rx_header.html";i:1516255478;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    $(function () {
        $.ajax({
            ...
            success:function (data) {
                if(data.res=='success'&&data.front_idcard!=''&&data.back_idcard!=''&&data.handheld_idcard!=''){
                    $('#nu').hide();
                    $('#always').show();
                    $('.names').eq(0).hide();
                    $('.names').eq(1).show();
