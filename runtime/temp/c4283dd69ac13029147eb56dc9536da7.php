<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:60:"C:\AppServ\www\tp\public/../xmyttz/rx\view\rx\buy_price.html";i:1516586098;s:27:"../xmyttz/view/rx_head.html";i:1516774617;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="buy_shop buy_price">
    <p class="hand">价格</p>
    <div class="hand_mes">
        <input type="text" value="63.47">
        <span class="span"><img src="/Public/img/buy_reduction.png" alt=""></span>
        <span class="span1"><img src="/Public/img/buy_add.png" alt=""></span>
    </div>
    <p class="hand">手数</p>
    <div class="hand_mes">
    ...
    <p class="buy_mess">最多可买: <span>0 <i>手</i></span></p>
</div>
