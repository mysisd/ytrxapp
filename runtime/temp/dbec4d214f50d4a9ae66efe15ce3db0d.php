<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:58:"C:\AppServ\www\tp\public/../xmyttz/rx\view\rx\rx_sell.html";i:1516613138;s:27:"../xmyttz/view/rx_head.html";i:1516774617;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="buy_all">
   ...
   <p class="buy_new"></p>
        <div class="buy_math">
            <ul>
                <li><span>卖价&nbsp;&nbsp;</span><span class="sell"></span></li>
                <li><span>买价&nbsp;&nbsp;</span><span class="pay"></span></li>
            </ul>
        </div>
        <div class="buy_but">
                <div class="but">
                    <ul>
                        <li><a href="/rx/rx/buy_shop_sell" class="shops" target="myFrameName">市价单 <p style="display: none"></p></a></li>
                        <li><a href="/rx/rx/buy_price_sell" target="myFrameName">限价单</a></li>
                        <li><a>条件单</a></li>
                    </ul>
                </div>
