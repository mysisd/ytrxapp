...
class App
{
    ...
    public static function module($result, $config, $convert = null){
        ...
        if($_SERVER['HTTP_HOST']=='xmyttz.cn'||$_SERVER['HTTP_HOST']=='www.xmyttz.cn'){
            header('xmyttz.com');
            $_SERVER['HTTP_HOST']='xmyttz.com/';
//            $config['default_module'] = $config['default_module_cn'];
//            $config['default_controller'] = $config['default_controller_cn'];
//            $config['default_action'] = $config['default_action_cn'];
        }
        if (is_string($result)) {
